...
public class Atividade11_sistema_cálculo_salário_bonificação_impostos {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Insira a quantidade de anos que o funcionário trabalhou na empresa: ");
